...
namespace ElementMachine.Machine
{
	public class EnergyLimiter : MachineItem
	{
        ...
        public override void SetStaticDefaults() 
		{
			...
			DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "能量限制器");
		    ...
		    Tooltip.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "减少你40点最大魔力, 2点防御与5%的魔法和召唤伤害, 但可以增加你15%的近战伤害与1点回血速度");
	    }
