...
namespace ElementMachine.Element.Ice.Frozen
{
    public class FrozenRuneStone : ElementItem
    {
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "霜寒符石");
            ...
            Tooltip.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "别问我冰和雪是怎么做成石头的\n反正它很冷就对了\n增加一点防御力,在雪地时则增加两点\n增加3%的近战伤害与2点穿甲");
